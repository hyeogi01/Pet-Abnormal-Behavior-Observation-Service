...
class _PetHealthDashboardState extends State<PetHealthDashboard> {
  ...
  Widget _buildDiaryItem(String date, String day, int activity, bool hasWarning) {
    return Container(
      ...
      child: Row(
        children: [
          Container(width: 40, height: 40, decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(8.r))),
          SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Icon(Icons.sentiment_satisfied_alt, color: Colors.lightGreen, size: 24),
        ],
      ),
    );
  }
